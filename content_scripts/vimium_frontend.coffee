...
performFindInPlace = ->
  ...
  findModeQueryHasResults = executeFind(false)
  if findModeQueryHasResults?
    findModeQueryHasResults.range.startContainer.parentNode.scrollIntoView()
...
executeFind = (backwards) ->
  ...
  result = selectMatch(findModeQuery.isRegex, findModeQuery.parsedQuery, !backwards)
...
findAndFocus = (backwards) ->
  ...
  findModeQueryHasResults = executeFind(backwards)
  if findModeQueryHasResults?
    findModeQueryHasResults.range.startContainer.parentNode.scrollIntoView()
...
HUD =
  ...
  show: (text) ->
    ...
    HUD.displayElement().textContent = text
